...
K.options = {
	...
	minChangeSize : 5,
	items : [
		'source','cut', 'copy', 'paste', 'plainpaste','|','justifyleft', 'justifycenter', 'justifyright',
		'table','emoticons','image', 'flash', 'media', 'insertfile', '/',
		'fontname', 'fontsize', '|', 'forecolor', 'hilitecolor', 'bold',
		'italic', 'underline', 'strikethrough', 'lineheight', '|', 'hr' ,'link', 'unlink','fullscreen'
	],
